...
onMounted(async () => {
  try {
    const getTitleChildByTitle = await pmTitleManage.getTitleChildData({title_id: title_id.value, title_child_id: title_child_id.value});
    console.log(getTitleChildByTitle.data.result[0]);
    ...
    value_input_type_1.value = getTitleChildByTitle.data.result[0].value_input_type_1;
    ...
    value_input_type_2.value = getTitleChildByTitle.data.result[0].value_input_type_2;
    ...
    value_input_type_3.value = getTitleChildByTitle.data.result[0].value_input_type_3;
