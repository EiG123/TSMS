  ...
  >
    ...
    <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
      ...
      <button
        ...
        @click="goDev"
        class="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-white bg-purple-600 hover:bg-purple-700 transition-all duration-200 shadow-md hover:shadow-lg group"
      >
        <svg
      ...
      <button
        ...
        @click="goAdmin"
        class="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-white bg-red-600 hover:bg-red-700 transition-all duration-200 shadow-md hover:shadow-lg group"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
